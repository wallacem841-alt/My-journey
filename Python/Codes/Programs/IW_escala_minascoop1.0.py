...
enfermeira1 = 'LUIZA ALICIA'
enfermeira2 = 'NATHIELE DE CASSIA'
enfermeira3 = 'CREUZA PEREIRA'
enfermeira4 = 'CREUSA SERAPI'
...
pyautogui.click(x=528, y=376)

ate_nome()

# 18.1 digitar nome

pyautogui.write(enfermeira1)

depois_nome()

# 22 loopar 15 ao 24 trocando impar/par dia/noite (começo 15 n pode estar no loop)
# 22.1 enfermeira 2, clicar impar noite

pyautogui.click(x=514, y=395)

ate_nome()

# 22.2 nome e finalização enfermeira 2

pyautogui.write(enfermeira2)

depois_nome()

# 22.3 enfermeira 3, clicar par dia

pyautogui.click(x=433, y=412)

ate_nome()

# 22.4 nome e finalização enfermeira 3

pyautogui.write(enfermeira3)

depois_nome()

# 22.5 enfermeira 4, clicar par noite

pyautogui.click(x=431, y=432)

ate_nome()

# 22.6 nome e finalização enfermeira 4

pyautogui.write(enfermeira4)
