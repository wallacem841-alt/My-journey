...
root = tkinter.Tk()
# GUI str
paciente = tkinter.Label(root, text='Paciente:')
paciente.grid(row=0, column=0)

Data1 = tkinter.Label(root, text='Data inicio:')
Data1.grid(row=1, column=0)

Data2 = tkinter.Label(root, text='Data fim:')
Data2.grid(row=2, column=0)

enfermeira1 = tkinter.Label(root, text='Enfermeira impar dia:')
enfermeira1.grid(row=3, column=0)

enfermeira2 = tkinter.Label(root, text='Enfermeira impar noite:')
enfermeira2.grid(row=4, column=0)

enfermeira3 = tkinter.Label(root, text='Enfermeira par dia:')
enfermeira3.grid(row=5, column=0)

enfermeira4 = tkinter.Label(root, text='Enfermeira par noite:')
enfermeira4.grid(row=6, column=0)

# GUI box

entry_paciente = tkinter.Entry(root, width=50, bg='#00bfff', fg='black', border=5)
entry_paciente.grid(row=0, column=1)

entry_Data1 = tkinter.Entry(root, width=50, bg='#00bfff', fg='black', border=5)
entry_Data1.grid(row=1, column=1)

entry_Data2 = tkinter.Entry(root, width=50, bg='#00bfff', fg='black', border=5)
entry_Data2.grid(row=2, column=1)

entry_enfermeira1 = tkinter.Entry(root, width=50, bg='#00bfff', fg='black', border=5)
entry_enfermeira1.grid(row=3, column=1)

entry_enfermeira2 = tkinter.Entry(root, width=50, bg='#00bfff', fg='black', border=5)
entry_enfermeira2.grid(row=4, column=1)

entry_enfermeira3 = tkinter.Entry(root, width=50, bg='#00bfff', fg='black', border=5)
entry_enfermeira3.grid(row=5, column=1)

entry_enfermeira4 = tkinter.Entry(root, width=50, bg='#00bfff', fg='black', border=5)
entry_enfermeira4.grid(row=6, column=1)

nome_paciente = entry_paciente.get()
data_inicio = entry_Data1.get()
data_fim = entry_Data2.get()

enfermeiras = [entry_enfermeira1.get(), entry_enfermeira2.get(), entry_enfermeira3.get(), entry_enfermeira4.get()]
loop_enfermeiras = [
...
mybutton = tkinter.Button(root, text='Rodar programa', padx=50, pady=50, command=run_program, fg='red', bg='black')
